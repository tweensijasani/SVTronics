...
def reports():
    try:
        ...
        title = "Enter Details"
        input_list = ["Serial No.", "No. of copies", "Time Interval in Hours", "Time Interval in Minutes", "Time Interval in Seconds"]
        ...
        nhours = int(output[2].strip()) if bool(output[2]) else 0
        nminutes = int(output[3].strip()) if bool(output[3]) else 0
        nseconds = int(output[4].strip()) if bool(output[4]) else 0
        logging.info("Naming info populated")
        # messagebox.showinfo(title="File Naming Info", message="Details inputted successfully!!!")
    ...
    try:
        ...
        # messagebox.showinfo(title="Report Details", message="Details inputted successfully!!!")
    ...
    try:
        ...
        # messagebox.showinfo(title="Inspection Counts", message="Details inputted successfully!!!")
